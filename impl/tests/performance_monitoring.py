...
class PerformanceMonitor:
    ...
    def analyze_trends(self, aggregated_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if build_times:
            ...
            trends["fastest_toolchain"] = min(avg_times, key=avg_times.get)
        ...
        if success_rates:
            ...
            trends["most_reliable_toolchain"] = max(avg_success, key=avg_success.get)
        ...
        if resource_usage:
            ...
            trends["most_efficient_toolchain"] = min(avg_efficiency, key=avg_efficiency.get)
...
def main():
    ...
    monitor = PerformanceMonitor(workspace_dir)
