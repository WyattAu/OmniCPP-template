...
class TestLoggingInfrastructureIntegration:
    ...
    def test_setup_logging_with_config_path(self, tmp_path) -> None:
    ...
    def test_convenience_functions(self, caplog) -> None:
        ...
        assert any("[SUCCESS] Test success message" in record.message for record in caplog.records)
        ...
        try:
            ...
            assert any("Test exception message" in record.message for record in caplog.records)
...
class TestCustomHandlersIntegration:
    ...
    def test_console_handler_emits_records(self, caplog) -> None:
    ...
    def test_file_handler_creates_log_directory(self, tmp_path) -> None:
    ...
    def test_file_handler_emits_records(self, tmp_path, caplog) -> None:
    ...
    def test_file_handler_with_json_format(self, tmp_path) -> None:
    ...
    def test_file_handler_rotation(self, tmp_path) -> None:
    ...
    def test_create_file_handler(self, tmp_path) -> None:
...
class TestLoggingIntegration:
    ...
    def test_logging_with_console_and_file(self, tmp_path, caplog) -> None:
    ...
    def test_logging_with_different_levels(self, caplog) -> None:
    ...
    def test_logging_with_multiple_loggers(self, caplog) -> None:
        ...
        assert any("Message from logger1" in record.message for record in caplog.records)
        assert any("Message from logger2" in record.message for record in caplog.records)
        assert any("Message from logger3" in record.message for record in caplog.records)

    def test_logging_with_context(self, caplog) -> None:
        ...
        assert any("context_key" in str(record) for record in caplog.records)

    def test_logging_with_exception_context(self, caplog) -> None:
        ...
        assert any("ValueError" in str(record) for record in caplog.records)

    def test_logging_level_changes(self, caplog) -> None:
    ...
    def test_logging_with_custom_format(self, caplog) -> None:
        ...
        assert any("[INFO] [test_level_change] Test message" in record.message for record in caplog.records)

    def test_logging_with_colored_output(self, caplog) -> None:
        ...
        # Verify colored output was enabled
        # Note: Actual color codes depend on terminal support
        assert any("Test message" in record.message for record in caplog.records)

    def test_logging_with_json_output(self, tmp_path, caplog) -> None:
    ...
    def test_logging_shutdown_and_restart(self, caplog) -> None:
        ...
        assert any("Message after restart" in record.message for record in caplog.records)
