...
Scene management provides a hierarchical structure for organizing game objects and managing scene transitions. This guide covers the [`Scene`](include/engine/scene/Scene.hpp:27), [`SceneNode`](include/engine/scene/SceneNode.hpp:26), and [`SceneManager`](include/engine/scene/SceneManager.hpp:23) classes.

## Scene Architecture

The scene system uses a tree-based scene graph for organizing entities:
