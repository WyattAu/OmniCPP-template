...
function(apply_assets_processing_qt_vulkan_standalone)
    ...
    if(WIN32)
        ...
        set(ASSET_BUILD_DIR "$<TARGET_FILE_DIR:${QT_VULKAN_STANDALONE_NAME}>/${ASSET_INSTALL_DIR}")
        set(INSTALL_DESTINATION "bin/${ASSET_INSTALL_DIR}")
        set(ASSET_PATH_DEFINE "${ASSET_INSTALL_DIR}")
    else() # UNIX/APPLE
        set(ASSET_INSTALL_DIR "share/${QT_VULKAN_STANDALONE_NAME}/assets")
        set(ASSET_BUILD_DIR "$<TARGET_FILE_DIR:${QT_VULKAN_STANDALONE_NAME}>/../${ASSET_INSTALL_DIR}")
    ...
    if(NOT ASSET_FILES)
        ...
        target_compile_definitions(
            ${QT_VULKAN_STANDALONE_NAME} PRIVATE ASSET_FILES="No asset files found in ${ASSET_SOURCE_DIR}.")
        return()
    endif()
    ...
    copy_assets(${QT_VULKAN_STANDALONE_NAME} "${ASSET_SOURCE_DIR}" "${ASSET_BUILD_DIR}")
